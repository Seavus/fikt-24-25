...
internal static class InitialData
{
    ...
    {
        User.Create(UserId.Create(new Guid("55b13cc2-b24b-4501-9c53-af6ade254194")), "John", "Doe", "john@example.com", "User_0123",1200,true),
        User.Create(UserId.Create(new Guid("ee8b09a5-6c99-4013-bca6-60b4c6f5c1f0")), "Jane", "Smith", "jane@example.com", "User_1234", 3000, true)
    };
